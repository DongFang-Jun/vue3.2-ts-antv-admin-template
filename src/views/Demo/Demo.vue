...
// 防抖测试
const debounceClick = () => {
  message.success('防抖按钮触发的事件')
}

// 节流测试
const throttleClick = () => {
  message.success('节流按钮触发的事件')
}
...
<template>
  <div class="container">
    ...
    <div class="test-button">
      <a-button type="primary" v-debounce:1000="debounceClick">防抖测试</a-button>
      <a-button type="primary" v-throttle:1000="throttleClick">节流测试</a-button>
    </div>
  </div>
</template>
